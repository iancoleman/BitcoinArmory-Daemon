...
print "listtransactions: %s" % json.dumps(access.listtransactions(5), sort_keys=True, indent=4, cls=UniversalEncoder)
print "listtransactions: %s" % json.dumps(access.listtransactions(5, 1), sort_keys=True, indent=4, cls=UniversalEncoder)
